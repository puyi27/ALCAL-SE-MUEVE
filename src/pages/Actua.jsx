  ...
  return (
    <div ref={containerRef} className="pt-32 pb-24 px-8 md:px-24 max-w-[100rem] mx-auto">
      ...
      <section className="mb-32">
        ...
        <p className="text-xl text-[#FBF5E9]/80 font-light max-w-3xl mb-12 reveal-item">
        ...
        <div className="w-full h-[700px] bg-[#FBF5E9] rounded-2xl flex items-center justify-center relative overflow-hidden reveal-item shadow-2xl">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span className="bg-[#117C4E] text-[#FBF5E9] px-6 py-3 rounded-full font-medium tracking-widest uppercase text-sm">
      ...
      <section>
        <div className="reveal-item mb-12">
          ...
          <p className="text-[#FBF5E9]/70 text-lg font-light max-w-2xl">
        ...
        <div className="flex flex-col gap-4 reveal-item">
          ...
          <div className="bg-[#117C4E]/10 border border-[#117C4E]/30 rounded-xl overflow-hidden">
            <button onClick={toggleAccordion} className="w-full px-8 py-6 flex items-center justify-between text-left hover:bg-[#117C4E]/20 transition-colors">
              <span className="text-xl font-serif text-[#FBF5E9]">1. Ayuntamiento de Alcalá de Guadaíra</span>
            ...
            <div className="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
              <div className="p-8 pt-0 text-[#FBF5E9]/70 font-light border-t border-[#117C4E]/10 mt-2">
                <p className="mb-4"><strong className="text-[#FBF5E9]">Vía presencial (recomendada):</strong> Acude al Registro General en Calle Rafael Santos, 6. Lleva tu escrito con tus datos, la incidencia clara, y pide que te sellen una copia.</p>
                <p><strong className="text-[#FBF5E9]">Vía telemática:</strong> A través de la Sede Electrónica buscando "Instancia General".</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#117C4E]/10 border border-[#117C4E]/30 rounded-xl overflow-hidden">
            <button onClick={toggleAccordion} className="w-full px-8 py-6 flex items-center justify-between text-left hover:bg-[#117C4E]/20 transition-colors">
              <span className="text-xl font-serif text-[#FBF5E9]">2. Consorcio de Transporte Metropolitano</span>
              <ChevronDown className="icon-chevron text-[#117C4E] transition-transform duration-300" />
            </button>
            <div className="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
              <div className="p-8 pt-0 text-[#FBF5E9]/70 font-light border-t border-[#117C4E]/10 mt-2">
                <p className="mb-4">Avda. Cristo de la Expiración, 2 – 41002 Sevilla.</p>
                <p className="text-red-400">Atención: El sistema telemático suele fallar ("no hay trámites disponibles"). Recomendamos hacerlo presencial o por correo certificado.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#117C4E]/10 border border-[#117C4E]/30 rounded-xl overflow-hidden">
            <button onClick={toggleAccordion} className="w-full px-8 py-6 flex items-center justify-between text-left hover:bg-[#117C4E]/20 transition-colors">
              <span className="text-xl font-serif text-[#FBF5E9]">3. Junta de Andalucía</span>
              <ChevronDown className="icon-chevron text-[#117C4E] transition-transform duration-300" />
            </button>
            <div className="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
              <div className="p-8 pt-0 text-[#FBF5E9]/70 font-light border-t border-[#117C4E]/10 mt-2">
                <p className="mb-4">Es la vía más formal a través del Libro de Sugerencias y Reclamaciones.</p>
                <a href="#" className="inline-flex items-center gap-2 text-[#117C4E] hover:underline">
