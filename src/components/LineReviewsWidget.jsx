        ...
        <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar flex flex-col gap-8">
          {lines.map((line) => (
            <div key={line.id} className="flex flex-col">
              ...
              <div className="flex items-center gap-3 mb-4 sticky top-0 bg-[#011B11] py-2 z-10">
              ...
              {/* Las 3 reseñas */}
              <div className="flex flex-col gap-3 pl-6 border-l border-[#FBF5E9]/10 ml-1.5">
                {reviewsByLine[line.id].map((review, idx) => (
                  <div key={idx} className="bg-[#FBF5E9]/5 p-4 rounded-xl hover:bg-[#FBF5E9]/10 transition-colors">
                    <p className="text-[#FBF5E9]/90 font-light italic text-sm leading-relaxed mb-3">
